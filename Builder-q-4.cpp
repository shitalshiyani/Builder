...
main()
{
	...
	cout<<"Enter Student Education School Name="<<h.stu_edu_school_name<<endl;
	cout<<"Enter Student Education College Name="<<c.stu_edu_college_name;
